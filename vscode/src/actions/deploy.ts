...
import { DeployContracts, DeployEnvironment, DeployScript } from "./types";
...
export async function getEnvironments(): Promise<DeployEnvironment[]> {
...
export async function deployContract(rpcUrl: string, contract: DeployContracts, verify: boolean, cstrArgs: string[]): Promise<void> {
