...
export class EnvironmentRepository {
    ...
    private _environmentPath: string;
    ...
    public load(): void {
        ...
        if (fs.existsSync(this._environmentPath)) {
            ...
            fs.writeFileSync(this._environmentPath, JSON.stringify({environments: []}));
            this._environment = [];
        }
    }
    ...
    public async createEnvironment(environment: DeployEnvironment): Promise<DeployEnvironment> {
