...
import { DeployContracts, DeployScriptArgs, DeployEnvironment, DeployScript} from "./actions/types"
import { deployContract, deployScript, getContracts, getEnvironments, getScripts } from "./actions/deploy";
...
export class SidebarProvider implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "sidebar", "dist", "index.js"),
    );

    const styleUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "sidebar", "dist", "index.css"),
    );
